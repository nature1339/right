...
export default function IntroPublicKr() {
        ...
        <div className="main-wrap">
          ...
          <div className="bottomBox">
            <div className="bottomBox-wrap">
              <span className="text1">글로벌 표준 거래소 퍼블릭을 통해</span>
          ...
          <section className="section3">
            ...
            <p>
              회원가입후 즉시 선물거래가 가능한 퍼블릭에서 여러분의 자산을 보다
              쉽고 빠르게 늘려보세요.
            </p>
          </section>
            ...
            <div className="section4-wrap">
              <ul className="section4-list">
                ...
                <li className="list-item">
                  ...
                  <p>퍼블릭에 존재하는 모든 선물 주식 동일하게 거래 가능</p>
                </li>
                <li className="list-item">
