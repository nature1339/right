    ...
    <section className="my-8">
      <div className="w-full max-w-[1180px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* 공지사항 */}
          <div className="bg-white rounded-xl shadow border border-[#E3E3E3] p-6">
            ...
            <ul className="space-y-2 text-base md:text-sm">
              <li className="flex justify-between">
                <span>(구)MTS 서비스 종료 사전안내 (4/30(수))</span>
                <span className="text-gray-400">25.03.08</span>
              </li>
              <li className="flex justify-between">
                <span>대체거래소(ATS) 오픈! 무엇이 바뀌는지 확인해 보세요!</span>
                <span className="text-gray-400">25.03.08</span>
              </li>
              <li className="flex justify-between">
                <span>금융사기 피해 예방을 위한 「금융거래목적확인제도」 안내</span>
                <span className="text-gray-400">25.03.08</span>
              </li>
            </ul>
          </div>
