  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-[1212px] px-[16px] mx-auto">
        ...
        <div className="text-base text-[#A3A3A3] mt-4">2025-04-02</div>
        <div className="p-0 md:p-12 border-0 md:border border-[#E3E3E3] rounded-3xl text-[#131313] text-[18px] mt-12">
          <div>
            <p className="">
            ...
            <div className="mt-7 mb-1 font-bold">개요</div>
            ...
            <div className="mt-7 mb-1 font-bold">
              신용거래(담보대출/융자)계좌의 유통대주 매매 제한
            </div>
            <table className="mt-2 text-[16px] border-t border-[#434343]">
              <thead>
                <tr>
                  <th className="text-left pl-6 py-1 h-[45px]">
                    <div className="flex items-center h-[30px] border-r border-[#E3E3E3]">
                      구분
                    </div>
                  </th>
                  <th className="text-left pl-6 h-[45px]">변경 사항</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="text-left pl-6 h-[45px]">변경전</td>
                  <td className="text-left pl-6 h-[45px]">
                    유통대주 매매를 포함한 담보대출 및 신용융자거래 모두 가능
                  </td>
                </tr>
                <tr>
                  <td className="text-left pl-6 h-[45px]">변경후</td>
                  <td className="text-left pl-6 h-[45px]">
            ...
            <div className="mt-7 mb-1 font-bold">시행일</div>
            <p className="mt-2">2025년 3월 31일</p>
            <p className="mt-7">
              ❖ 기타 자세한 문의사항은 영업점 또는 고객지원센터 080-851-8282
              (주문전용 080-851-8200, ARS 080-852-1234, 해외에서 이용 시
              82-2-6906-4201)로 문의해주시기 바랍니다.
            </p>
          </div>
          <div className="p-6 flex bg-[#F9F9F9] rounded-2xl mt-8">
        ...
        <a
          href="#"
          className="flex items-center justify-center mx-auto my-12 w-[200px] h-[56px] bg-[#324580] text-white rounded-md text-[18px] font-semibold"
        >
          목록으로
        </a>
        <div className="p-8 border border-[#E3E3E3] rounded-3xl text-[#131313] text-[18px] flex justify-between">
          <a href="#" className="block border-0 w-1/2 pr-2">
            <div>
              <div className="flex items-center gap-4">
                <HiChevronLeft />
                <span className="font-semibold text-[18px]">이전</span>
              </div>
              <div className="mt-2 text-[#636363] text-[18px] truncate">
                마이데이터 서비스 중단 안내
              </div>
            </div>
          </a>
          <a href="#" className="block border-0 w-1/2 pl-2">
            <div>
